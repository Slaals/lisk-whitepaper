...
Chaque nom d'utilisateur est unique. La taille est actuellement limitée à 16 caractères. Ce n'est pour l'instant pas possible de supprimer un nom d'utilisateur.
